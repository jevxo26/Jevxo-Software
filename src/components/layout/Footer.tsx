...
const socials = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.777-1.564-3.285-4.887-4.574.98-2.43 1.737-4.902 1.83-5.22-.52-.397-1.077-.745-1.678-1.04-.08.283-.787 2.628-1.748 4.965-2.915-.99-5.753-1.033-6.12-1.036-.022.378-.04 2.836.425 5.568-3.084.908-5.26 2.92-5.46 3.11.45.544.97 1.023 1.543 1.433.04-.038 1.91-1.776 4.93-2.617.915 2.473 1.562 5.166 1.728 5.952.623.14 1.272.215 1.937.215.19 0 .375-.01.563-.02-.132-.835-.758-3.603-1.637-6.222 3.125.892 5.756 3.25 5.937 3.42.593-.6 1.107-1.28 1.53-2.026-.065-.054-2.316-2.073-5.228-3.21 1.054-2.64 1.92-5.433 2.1-6.035z"/>
      </svg>
    )
  }
];
