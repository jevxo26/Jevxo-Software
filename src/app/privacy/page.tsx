    ...
    <div className="bg-[#080d1a] text-[#f1f5f9] min-h-screen flex flex-col">
      ...
      <section className="py-[100px] md:py-[70px] pb-[100px]">
        <div className="w-11/12 max-w-[1400px] mx-auto max-w-[800px]">
          <div className="bg-white/70 border border-slate-900/[0.08] backdrop-blur-xl shadow-[0_8px_32px_rgba(15,23,42,0.04)] hover:bg-white/95 hover:border-slate-900/[0.16] transition-all duration-200 p-10 rounded-2xl bg-white/[0.01] border-white/[0.06] text-sm leading-relaxed text-slate-600">
            <h2 className="text-xl font-bold text-[#fff] mb-4">1. Information We Collect</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-bold text-[#fff] mb-4">2. How We Use Data</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-bold text-[#fff] mb-4">3. Data Storage & Security</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-bold text-[#fff] mb-4">4. Cookies & Trackers</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-bold text-[#fff] mb-4">5. Contact Inquiries</h2>
            <p className="m-[0]">
